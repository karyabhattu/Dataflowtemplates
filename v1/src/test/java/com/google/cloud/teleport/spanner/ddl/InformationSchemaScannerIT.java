...
public class InformationSchemaScannerIT {
  ...
  public void identityColumns() throws Exception {
    List<String> statements =
        Arrays.asList(
            "ALTER DATABASE `" + dbId + "` SET OPTIONS ( default_sequence_kind = \"bit_reversed_positive\" )",
            "CREATE TABLE `T` ("
  ...
  public void pgIdentityColumns() throws Exception {
    List<String> statements =
        Arrays.asList(
            "ALTER DATABASE \"" + dbId + "\" SET spanner.default_sequence_kind = 'bit_reversed_positive'",
            "CREATE TABLE \"T\" ("
